...
mul=input_struct.new_res/def_res;

load(['..\data\model' num2str(input_struct.model_phantom) '\model' num2str(input_struct.model_phantom) '.mat'])
% siz=size(Debye_fine_test_model);
% Debye_coarse_2D_model=zeros(siz/mul);
% Debye_coarse_2D_model_EpsDelta=zeros(siz/mul);
% Debye_coarse_2D_model_EpsInf=zeros(siz/mul);
% Debye_coarse_2D_model_Sigma_s=zeros(siz/mul);
...
% Debye_coarse_2D_model=imresize(Debye_fine_test_model,1/mul,'nearest');
% Debye_coarse_2D_model_EpsDelta=imresize(Debye_fine_test_model_EpsDelta,1/mul,'nearest');
% Debye_coarse_2D_model_EpsInf=imresize(Debye_fine_test_model_EpsInf,1/mul,'nearest');
% Debye_coarse_2D_model_Sigma_s=imresize(Debye_fine_test_model_Sigma_s,1/mul,'nearest');
