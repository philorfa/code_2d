function Calibration_fun_normalization(mag0, pha0, mag1, pha1, background_path, frequency,model_phantom)
...
save(['..\data\model' num2str(model_phantom) '\Calibrated_data'],'Calibrated_Mag','Calibrated_Pha','frequency');
disp('Calibrated data have been saved !');
end